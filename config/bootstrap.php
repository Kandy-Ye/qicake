<?php 
  ...
  define('CATEGORY_RECYCLE_ID', 4);
	...
	// Programing control
	define('JQUERY', 'jquery/jquery-2.0.3.min');
	define('JQUERY_UI', 'jquery/jquery-ui-1.8.2.custom.min');
	define('JQUERY_UI_CSS', 'jquery/ui-lightness/jquery-ui-1.8.9.custom');
	define('BOOTSTRAP', 'bootstrap/bootstrap.min');
	define('BOOTSTRAP_CSS', 'bootstrap/bootstrap');
	define('BOOTSTRAP_THEME_CSS', 'bootstrap/bootstrap-theme');
	define('JSON2', 'json2');
